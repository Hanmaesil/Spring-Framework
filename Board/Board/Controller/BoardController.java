...
public class BoardController {
	...
	public String boardList(Model model) { //사용하고자하는 저장공간을 매개변수에 넣어주면 된다(request도 서블릿에 있지만 이렇게 사용이 가능하다!)
	...
	public String boardContents(int idx, Model model) { //get방식 하나만 받을 때! >> 받고자 하는 데이터 타입을 적어주면 끝!(거즘 vo타입으로 받기는 한다) 
